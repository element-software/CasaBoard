...
export default function BillingContent({ entitlements }: { entitlements: Entitlements }) {
  const tiers = [
    { id: "starter", name: "Starter", price: "£5/mo", features: ["1 dashboard"] },
    { id: "mid", name: "Mid", price: "£8/mo", features: ["3 dashboards"] },
    { id: "pro", name: "Pro", price: "£10/mo", features: ["6 dashboards"] },
    { id: "super_25", name: "Super 25", price: "£25/mo", features: ["3 HA", "10 dashboards"] },
    { id: "super_40", name: "Super 40", price: "£40/mo", features: ["5 HA", "20 dashboards"] },
    { id: "super_60", name: "Super 60", price: "£60/mo", features: ["10 HA", "50 dashboards"] },
  ];
  ...
  return (
    <div className="max-w-7xl w-full mx-auto py-10">
      ...
      {!entitlements.active && (
        <p className="mb-6 text-warning">Your trial has ended or is inactive. Pick a plan below to continue.</p>
      )}
        ...
        {tiers.map((tier) => (
          <Card key={tier.id}>
            <CardBody className="space-y-3">
              ...
              <form action={`/api/billing/checkout?plan=${tier.id}`} method="post">

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-8">
          ...
          <CardBody className="space-y-4">
            <p className="text-theme-text-secondary">
              CasaBoard uses Google OAuth for secure authentication. Follow
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 p-4 bg-theme-surface rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-theme-text-secondary text-sm">
                    Choose the Google account you want to use for CasaBoard.
                    This will be your primary account for accessing the
                    dashboard.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-theme-surface rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-theme-text-secondary text-sm">
                    Review and accept the permissions requested by CasaBoard.
                    This allows secure access to your account.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-theme-surface rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-theme-text-secondary text-sm">
                    Once authenticated, you&apos;ll be redirected back to
                    CasaBoard and can start setting up your dashboard.
                  </p>
                </div>
              </div>
            </div>
        ...
        <Card className="mb-8">
          ...
          <CardBody className="space-y-4">
            <p className="text-theme-text-secondary">
              Connect your Home Assistant instance to CasaBoard to start
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-4 bg-theme-surface rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-theme-text-secondary text-sm">
                    Find your Home Assistant URL (e.g.,
                    http://homeassistant.local:8123 or https://your-domain.com)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-theme-surface rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-theme-text-secondary text-sm">
                    ...
                    → Create token. Give it a name like &quot;CasaBoard&quot;
                    and copy the token.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-theme-surface rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-theme-text-secondary text-sm">
                    Click &quot;Test Connection&quot; to verify that CasaBoard
                    can connect to your Home Assistant instance.
                  </p>
                </div>
              </div>
            </div>
          ...
          <CardBody className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="p-4 bg-theme-surface rounded-lg">
                ...
                <p className="text-sm text-theme-text-secondary">
                  Check our comprehensive documentation for detailed guides and
                  API references.
                </p>
              </div>
              <div className="p-4 bg-theme-surface rounded-lg">
                ...
                <p className="text-sm text-theme-text-secondary">
                  Join our community forum to ask questions and share your
                  experiences.
                </p>
              </div>
            </div>

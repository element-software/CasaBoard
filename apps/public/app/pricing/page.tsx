    ...
    <>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse at 20% 50%, rgba(167,139,250,0.35) 0%, transparent 55%), radial-gradient(ellipse at 80% 20%, rgba(99,102,241,0.40) 0%, transparent 55%)",
          }}
        />
        <div
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-48 pb-20 text-center">
          ...
          <div className="flex justify-center mb-6">
            <div className="p-4 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
              <Icon path={mdiTag} className="w-12 h-12 text-white" />
            </div>
          </div>
          ...
          <p className="text-violet-200/80 text-lg max-w-2xl mx-auto mb-10">
            Pick a plan that suits you. Upgrade or cancel anytime — no surprises.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            {[
              { icon: mdiCalendarMonth, label: "Monthly & Yearly" },
              { icon: mdiClose, label: "Cancel anytime" },
      ...
      <Pricing stripePlans={stripePlans} />
    </>
  );
}

const terms = [
  ...
  "Since you are allowing us to store your data, specficially your Home Assistant instance data, you are agreeing to hold us harmless from any data loss or damage or inconvenience or loss of data or any other loss or damage. We will not be held responsible for any data loss, breaches, or inconsistencies with your Home Assistant instance data.",

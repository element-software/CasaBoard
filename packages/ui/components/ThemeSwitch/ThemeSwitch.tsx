  ...
  return (
    <div className={classNames("relative", className)}>
      <button
        ...
        className="flex items-center space-x-2 p-2 text-theme-secondary hover:text-theme-text hover:bg-theme-secondary rounded-lg transition-colors"
      ...
      {isOpen && (
        <div className="absolute w-full bottom-full left-0 mt-2 py-2 bg-theme-secondary border border-theme-border rounded-lg shadow-lg z-50 min-w-[160px]">

  ...
  return (
    <main className="flex h-screen flex-col items-center p-8">
      <div className="grid grid-cols-3 gap-2 w-full">
        <div className="relative rounded-md overflow-hidden w-full shadow flex flex-col items-center text-center justify-between space-y-2 p-4 h-40 cursor-pointer bg-stone-500" onClick={() => setOpen(!open)}>
